...
**Delivery readiness** — Whether this installation holds every delivery secret
that email delivery needs, and the names of the secrets it still lacks. It
...
this check makes no network call. See ADR-0019.
