...
| `foundry.page.restructure` | `content.draft`, and `design.draft` as well when the request names an arrangement | None | New immutable revision with that page's sections changed |
