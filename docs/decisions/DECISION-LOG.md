...
| [ADR-0035](ADR-0035-mcp-page-restructure-and-draft-scoped-variants.md) | An agent changes a page's sections through one operation list, and every arrangement is checked against the draft | Accepted | 2026-09-20 |
