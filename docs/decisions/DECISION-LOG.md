...
| [ADR-0044](ADR-0044-contact-form-component-and-form-to-inbox-contract.md) | The contact form is a foundation page component, and a page block names the declared form it sends to | Accepted | 2026-09-21 |
