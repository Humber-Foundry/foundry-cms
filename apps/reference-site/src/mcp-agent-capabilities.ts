 ...
 * shipped yet, such as uploading a photo.
 */
...
> = {
  ...
  "content.draft":
    "Prepare draft changes to your pages and posts — their words, which sections a page holds, pages it adds or removes, and new blog posts it writes — as a new draft you review before it goes live. It can also take a post out of your blog and put one back.",
  "design.draft":
 ...
 * today: no tool uploads a photo, takes a live post off your site on its own,
 * or sends a newsletter to more than the Owner's own test addresses.
 */
export const mcpAgentNeverDoes: ReadonlyArray<string> = Object.freeze([
  ...
  "It can write a blog post, but it cannot upload a photo. It can only use photos your site already holds.",
