 ...
 * shipped yet, such as creating a new page, starting a blog post from
 * nothing, or uploading a photo.
 */
...
> = {
  ...
  "content.draft":
    "Prepare draft edits to the text of existing pages and posts, as a new draft you review before it goes live.",
  "design.draft":
 ...
 * today: no tool creates a page, writes a blog post from nothing, uploads a
 * photo, or sends a newsletter to more than the Owner's own test addresses.
 */
export const mcpAgentNeverDoes: ReadonlyArray<string> = Object.freeze([
  ...
  "It cannot create a new page, start a new blog post from nothing, or upload a photo. Those are not built yet.",
