...
export type HumanAccessEnvironment = Readonly<{
  ...
  FOUNDRY_TIME_ZONE_DATABASE_VERSION?: string;
  ...
  FOUNDRY_BREVO_API_KEY?: string;
  FOUNDRY_BREVO_WEBHOOK_AUTH_TOKEN?: string;
  FOUNDRY_CAMPAIGN_TEST_PROOF_KEY?: string;
  FOUNDRY_BREVO_ACCOUNT_SCOPE_FINGERPRINT?: string;
  FOUNDRY_BREVO_PROVISIONING_EVIDENCE_JSON?: string;
  FOUNDRY_BREVO_SENDERS_JSON?: string;
  FOUNDRY_CAMPAIGN_TEST_RECIPIENTS_JSON?: string;
